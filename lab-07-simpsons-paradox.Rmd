...
```
***This doesn't meet my expectation as I did not think that smokers would be alive 20 years later, as it appears in the datasets.***
...
ggplot(data=Whickham, aes(y=outcome, fill=smoker)) +
  ...
  ggtitle("Distribution of Outcome")
```
***In the plot, it appears that smokers have a higher probability to be dead in each age category.***
